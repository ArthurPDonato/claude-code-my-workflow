...
\RB{B.3.3 / B.10.2 — Premissa de não-interferência (SUTVA) discutida analiticamente, não apenas declarada. A zona de exclusão donut (>50\% tratados; ≤0,5\% doadores) é justificada aqui como mecanismo de mitigação. Limitação retomada nas Considerações Finais.}
...
\RA{A.3 — Tabela comparativa dos estimadores introduzida para facilitar a leitura da seção metodológica, conforme indicado como necessidade de clareza.}
...
\label{sub:pool}
\RB{B.3.3 / B.9 — Design donut: limiar de $\leq 0{,}5\%$ define a zona de exclusão que mitiga SUTVA (contaminação do contrafactual). Os mesmos 193 municípios são usados para o teste de permutação direta, substituindo o kNN de seleção opaca da versão original.}
...
\RA{A.3 — Os três estimadores da seção metodológica são aplicados aqui com comparação sistemática, respondendo à necessidade de clareza sobre o papel de cada método.}
