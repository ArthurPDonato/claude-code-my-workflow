...
pool doador de unidades comparáveis não afetadas. A aleatoriedade temporal condicional das inundações fornece a base para assumir que o
momento exato do evento é exógeno condicional à exposição histórica ao risco,
satisfazendo a condição de tratamento exógeno requerida pelo SC \cite{elsner2024}.
...
Tratados (ATT) potencialmente viesadas \cite{abadie2021}. O SDiD contorna esse problema ao trabalhar em primeira diferença:
