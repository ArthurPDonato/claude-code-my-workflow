...
convergem em torno de um quarto do fluxo habitual de contratações: $-23{,}1\%$
em Eldorado do Sul (média pré: $16{,}1$ admissões por mil\,hab./mês), $-24{,}9\%$
em Roca Sales (média pré: $15{,}0$) e $-24{,}2\%$ em Muçum (média pré: $21{,}0$).
Para Travesseiro, o efeito relativo é mais intenso ($-44{,}0\%$), reflexo de uma
base de atividade formal comparativamente menor ($8{,}5$ admissões por
mil\,hab./mês) — coerente com o perfil de economia rural de pequeno porte do Vale
do Taquari. Em Arambaré e Igrejinha, cujos ATTs não são estatisticamente
significantes, as variações relativas são de $-1{,}7\%$ e $-7{,}9\%$,
respectivamente.
...
compartilham o mesmo pool de 193 doadores — violando a suposição de independência
