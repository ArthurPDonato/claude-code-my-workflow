...
pontuais — não à significância estatística. Para a maioria dos municípios, os ICs
...
estimativa parcial do impacto de longo prazo. \emph{Quarta}, a significância
estatística formal repousa quase inteiramente na inferência por permutação do SDiD;
para a maioria dos municípios, os ICs do TWFE-DiD e do SC cruzam zero — reflexo, em
parte, das distinções estruturais de potência entre procedimentos de inferência
detalhadas na Subseção~\ref{sub:triangulacao}. Isso não invalida a triangulação, mas
implica que a leitura de robustez deve ser feita em termos de convergência de sinal e
de ordem de grandeza, e não de replicação da significância estatística entre
estimadores.
...
\begin{table}[htbp]
\centering
\caption{Robustez — triangulação de estimadores: ATT em saldo líquido de admissões por
