...
da aleatoriedade condicional intrínseca à ocorrência de eventos físicos extremos, em
...
particularmente relevante para desastres de alcance regional amplo,
...
lado a lado — separadas por grupo de resultado (municípios com efeito significante
e sem efeito detectável, respectivamente), permitindo comparação visual direta
...
(esquerda) e saldo líquido (direita): municípios com efeito significante (Eldorado do
Sul, Muçum, Roca Sales, Travesseiro). Linha vertical tracejada: mai./2024.
\textbf{Esquerda (azul):} admissões formais; \textbf{direita (vermelho):} saldo
líquido. Linha tracejada cinza: controle sintético SDiD. Fonte: elaboração própria.}
...
Igrejinha). Linha vertical tracejada: mai./2024.
\textbf{Esquerda (azul):} admissões formais; \textbf{direita (vermelho):} saldo
líquido. Linha tracejada cinza: controle sintético SDiD. Fonte: elaboração própria.}
